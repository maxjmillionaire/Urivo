...
-- It applies migrations 0001–0063 in order. Safe to run once on a fresh project.
--
...
-- ─────────────────────────────────────────────────────────
-- 0054_storefront_view_owner_only_stores.sql
-- ─────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────
-- 0061_marketing_opt_in_default_off.sql
-- ─────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────
-- 0062_weekly_digest_marketing_gate.sql
-- ─────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────
-- 0063_reset_marketing_consent_baseline.sql
-- ─────────────────────────────────────────────────────────
