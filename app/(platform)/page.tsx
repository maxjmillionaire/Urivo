...
const FAQ = (foundingOpen: boolean): [string, string][] => [
  [
    ...
    "A full storefront: a brand name and identity, a curated product catalog with copy and pricing, and a store you can take live. You describe the business in a sentence; Urivo builds the rest, and you edit anything from there.",
  ],
  [
    "How do credits work?",
    `Every account starts with ${PLANS.free.signupCredits} free credits — enough to generate your first store and keep refining it. Generating a store costs ${CREDIT_COSTS.storeGeneration} credits; a message to the AI assistant costs ${CREDIT_COSTS.askMessage}. Paid plans add a monthly allowance, and your balance and history stay in Billing.`,
  ],
  /*
  ...
  [
    ...
    `No — publishing is a paid feature. On Free you can generate a full store and refine it as much as you want; taking it live needs ${PLANS.core.name} or ${PLANS.pro.name}. ${PLANS.core.name} runs up to ${PLANS.core.maxLiveStores} live stores, and ${PLANS.pro.name} is unlimited.`,
  ],
  [
  ...
  ...(foundingOpen
    ? ([
        [
          ...
          `The first 50 people to create a Urivo account lock in launch pricing — ${PLANS.core.name} at ${formatPrice(PLANS.core.price.founding ?? PLANS.core.price.regular)} instead of ${formatPrice(PLANS.core.price.regular)}, ${PLANS.pro.name} at ${formatPrice(PLANS.pro.price.founding ?? PLANS.pro.price.regular)} instead of ${formatPrice(PLANS.pro.price.regular)}. Your spot is reserved when you sign up, not when you pay, and the price stays fixed for as long as you're subscribed. After 50 accounts, new signups pay standard pricing.`,
        ],
      ] as [string, string][])
    : []),
  [
