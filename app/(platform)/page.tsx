...
const TIERS = [PLANS.free, PLANS.core, PLANS.pro].map((p) => ({
  name: p.name,
  launch: formatPrice(p.price.launch),
...
const FAQ: [string, string][] = [
  ...
  [
    "Is the founder pricing really locked for life?",
    "Yes. Subscribe during the launch window and your price stays fixed for the lifetime of your subscription — even as standard prices rise.",
  ],
  [
